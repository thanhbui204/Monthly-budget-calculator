...
var budgetController = (function() {
  ...
  return {
    addItem: function(type, des, val) {
      ...
      //Instead of using " data.allItems.exp.push(newItem)"
      //              or " data.allItems.inc.push(newItem)"
  ...
  return {
    getInput: function() {
      return {
        ...
        type: $(DOMstrings.inputType).val(), // will be wither inc(ome) or exp(enses)
    ...
    clearFields: function() {
      ...
      //convert object-like-array to array
    ...
    displayBudget: function(obj) {
      if (obj.budget>= 0){
        $(DOMstrings.budgetLabel).text(formatNumber(obj.budget,'inc'));
      }
      else if (obj.budget < 0) {
        $(DOMstrings.budgetLabel).text(formatNumber(obj.budget,'exp'));
      }
    ...
    changedType: function(){
      ...
      var fields = $(DOMstrings.inputType + ',' +
...
var controller = (function(budgetCtrl, UICtrl) {
  ...
  var setupEventListener = function() {
    $(DOM.inputBtn).on('click', ctrlAddition);
  ...
  var updatePercentages = function() {
    ...
    // 2. Read percentages from the buget budgetController
  ...
  var ctrlAddition = function() {
    ...
    if (input.description != "" && !isNaN(input.value) && input.value != 0) {
      // 2. Add the item to the buget budgetController
